...
import (
	...
	"github.com/dgraph-io/travel/app/service/handlers"
...
func run(log *log.Logger) error {
	...
	log.Println("main : Started : Application initializing : version")
	...
	api := http.Server{
		...
		Handler:      handlers.API(build, shutdown, log, gqlConfig),
